export const en = {
  ...
  trust: {
    ...
    pillars: {
      authenticity: {
        ...
        description:
          "Every piece verified and certified for genuine excellence",
      },
      expertise: {
        title: "Expert Guidance",
        description:
          "Personal consultation from our knowledgeable specialists",
      },
      craftsmanship: {
  ...
  aboutPage: {
    ...
    values: {
      ...
      authenticityDesc:
        "Every piece we offer is verified and certified, ensuring genuine quality and provenance.",
      ...
      legacy: "Legacy",
      legacyDesc:
        "Creating heirlooms that will be cherished and passed down through generations.",
    },
    teamLabel: "Our Team",
